...
// Motor setup
pros::MotorGroup left_mg({1, 2, 3}); // left motors
pros::MotorGroup right_mg({-11, -12, -13}); // right motors
pros::Motor bottom_intake(18); // bottom intake
pros::Motor top_intake(-20); // top intake
